...
window.PORTFOLIO_CONTENT = {
  ...
  enterpriseCareer: {
    ...
    items: [
      ...
      {
        year: '2023',
        company: { ko: 'SK 가스 (최종 고객사)', en: 'SK Gas (End Client)' },
      ...
      {
        year: '2023',
        company: { ko: '그린카 (최종 고객사)', en: 'Greencar (End Client)' },
      ...
      {
        year: '2022',
        company: { ko: '아모레퍼시픽 (최종 고객사)', en: 'Amorepacific (End Client)' },
      ...
      {
        year: '2022',
        company: { ko: 'SK 하이닉스 (최종 고객사)', en: 'SK Hynix (End Client)' },
